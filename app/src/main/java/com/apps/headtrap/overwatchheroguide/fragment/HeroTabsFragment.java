...
import com.apps.headtrap.overwatchheroguide.adapter.HeroTabAdapter;
 ...
 */
public class HeroTabsFragment extends BaseFragment {

    private static TabLayout tabLayout;
    private ViewPager viewPager;

    public HeroTabsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hero_tab, container, false);
        viewPager = (ViewPager) view.findViewById(R.id.viewpager);
        viewPager.setOffscreenPageLimit(2);

        viewPager.setAdapter(new HeroTabAdapter(getContext(), getChildFragmentManager()));
